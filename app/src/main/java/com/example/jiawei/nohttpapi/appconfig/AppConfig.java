 ...
 */
package com.example.jiawei.nohttpapi.appconfig;

import android.content.Context;
import android.content.SharedPreferences;

import com.example.jiawei.nohttpapi.BaseApplication;
import com.example.jiawei.nohttpapi.utils.FileUtil;
...
public class AppConfig {
    ...
    private AppConfig() {
        preferences = BaseApplication.getInstance().getSharedPreferences("nohttp_sample", Context.MODE_PRIVATE);
